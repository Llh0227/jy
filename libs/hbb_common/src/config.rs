...
pub const RENDEZVOUS_SERVERS: &[&str] = &["115.231.35.89"];
pub const RS_PUB_KEY: &str = "sjlpFD6DfLZfYxmQ6eLIeZpXJKTpiynRFK7rS3TgjBM=";

pub const RENDEZVOUS_PORT: i32 = 11162;
pub const RELAY_PORT: i32 = 11172;
pub const WS_RENDEZVOUS_PORT: i32 = 11182;
pub const WS_RELAY_PORT: i32 = 11192;
